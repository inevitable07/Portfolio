    ...
    <div>
      ...
      {loading ? (
        ...
        <div className="text-center py-20 text-white/30">
          ...
          <p className="text-sm">Click &ldquo;+ Add Achievement&rdquo; to create your first achievement.</p>
        </div>
      ) : (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-2 mt-0.5">
                  {a.description && (
                    <span className="text-[10px] text-white/30 truncate max-w-[240px]">{a.description}</span>
                  )}
                  <span className="text-[10px] text-white/25">Order: {a.order}</span>
                </div>
              </div>
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                <Link
                  href={`/admin/achievements/${a._id}/edit`}
